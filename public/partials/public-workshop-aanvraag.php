...
?>
	...
	<div class="kleistad-row" >
		...
		<div class="kleistad-col-3 kleistad-label" >
			<input name="naam" id="kleistad_kinderfeest" type="radio" required value="kinderfeest" <?php checked( $data['input']['naam'], 'kinderfeest' ); ?> >
			<label for="kleistad_kinderfeest" >Kinderfeest</label>
		</div>
		<div class="kleistad-col-3 kleistad-label" >
			<input name="naam" id="kleistad_workshop" type="radio" required value="workshop" <?php checked( $data['input']['naam'], 'workshop' ); ?> >
	...
	<div class="kleistad-row" >
		...
		<div class="kleistad-col-4 kleistad-label" >
			<input name="omvang" id="kleistad_klein" type="radio" required value="6 of minder" <?php checked( $data['input']['omvang'], '6 of minder' ); ?> >
	...
	<div class="kleistad-row" >
		...
		<div class="kleistad-col-4 kleistad-label" >
			<input name="omvang" id="kleistad_middel" type="radio" required value="tussen 7 en 12" <?php checked( $data['input']['omvang'], 'tussen 7 en 12' ); ?> >
	...
	<div class="kleistad-row" >
		...
		<div class="kleistad-col-4 kleistad-label" >
			<input name="omvang" id="kleistad_groot" type="radio" required value="meer dan 12" <?php checked( $data['input']['omvang'], 'meer dan 12' ); ?> >
	...
	<div class="kleistad-row" >
		...
		<div class="kleistad-col-4 kleistad-label" >
			<input name="periode" id="kleistad_kt" type="radio" required value="binnen 1 maand" <?php checked( $data['input']['omvang'], '6 of minder' ); ?> >
	...
	<div class="kleistad-row" >
		...
		<div class="kleistad-col-4 kleistad-label" >
			<input name="periode" id="kleistad_mt" type="radio" required value="tussen 1 en 2 maanden" <?php checked( $data['input']['omvang'], 'tussen 1 en 2 maanden' ); ?> >
	...
	<div class="kleistad-row" >
		...
		<div class="kleistad-col-4 kleistad-label" >
			<input name="periode" id="kleistad_lt" type="radio" required value="over 3 maanden of later" <?php checked( $data['input']['omvang'], 'over 3 maanden of later' ); ?> >
	...
	<div class ="kleistad-row" title="Heb je nadere vragen, stel ze gerust. Of laat hier opmerkingen achter die van belang zouden kunnen zijn voor Kleistad" >
		...
		<div class="kleistad-col-7 kleistad-input">
			<textarea class="kleistad-input" name="vraag" id="kleistad_vraag" maxlength="1000" rows="5" cols="50"><?php echo esc_textarea( $data['input']['vraag'] ); ?></textarea>
		</div>
	</div>
