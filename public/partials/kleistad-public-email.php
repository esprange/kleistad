...
// Onderstaand code om standalone de email te kunnen valideren.
// phpcs:disable
if ( ! isset( $text ) ) {
	$text = 'Een test bericht';
}
if ( ! isset( $emailadresses ) ) {
	$emailadresses         = [];
	$emailadresses['info'] = 'kleistad@example.org';
}
if ( ! function_exists( 'esc_attr' ) ) {
	// @phan-suppress-next-line PhanRedefineFunction
	function esc_attr( $p ) { echo $p; }
}
if ( ! function_exists( 'esc_html' ) ) {
	// @phan-suppress-next-line PhanRedefineFunction
	function esc_html( $p ) { echo $p; }
}
// phpcs:enable
