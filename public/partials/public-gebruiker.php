...
<div class ="kleistad-row" title="Wat is je ervaring met klei? Je kunt hier ook andere opmerkingen achterlaten die van belang zouden kunnen zijn voor Kleistad" >
	...
	<div class="kleistad-col-7 kleistad-input">
		<textarea class="kleistad-input" name="opmerking" id="kleistad_opmerking" maxlength="1000" rows="3" cols="50"><?php echo esc_textarea( $data['input']['opmerking'] ); ?></textarea>
	</div>
</div>
<div class="kleistad-row">
...
<?php if ( ( isset( $data['verklaring'] ) && '' !== $data['verklaring'] ) ) : ?>
	<div class="kleistad-row">
		<div class="kleistad-col-10">
			...
			<label for="verklaring"><?php echo $data['verklaring']; // phpcs:ignore ?></label>
		</div>
	</div>
<?php endif ?>
