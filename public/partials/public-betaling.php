...
if ( isset( $data['actie'] ) ) :
	...
	if ( Public_Main_Betaling::ACTIE_RESTANT_CURSUS === $data['actie'] ) :
		...
		<div class="kleistad_row">
			...
			<?php
	elseif ( Public_Main_Betaling::ACTIE_VERVOLG_ABONNEMENT === $data['actie'] ) :
		...
		<div class="kleistad_row">
			...
			<div class="kleistad_col_6">
				<p>&euro; <?php echo esc_html( number_format_i18n( $data['abonnement']->bedrag( \Kleistad\Abonnement::BEDRAG_MAAND ), 2 ) ); ?> </p>
			</div>
		</div>
		<div class="kleistad_row">
			<div class="kleistad_col_4">
		...
		<div class="kleistad_row">
			...
			<div class="kleistad_col_6">
				<p>&euro; <?php echo esc_html( number_format_i18n( $data['abonnement']->bedrag( \Kleistad\Abonnement::BEDRAG_OVERBRUGGING ), 2 ) ); ?></p>
			</div>
		</div>
		<div class="kleistad_row">
			<div class="kleistad_col_10">
		...
		<?php
	elseif ( Public_Main_Betaling::ACTIE_WORKSHOP === $data['actie'] ) :
		$this->form();
		?>
