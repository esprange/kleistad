...
//                            $( '#kleistad_abo_einde' ).prop( { checked: false, disabled: false } );
                            $( '.kleistad_abo_einde' ).hide();
//                            $( '#kleistad_abo_start' ).prop( { checked: false, disabled: false } );
                            $( '.kleistad_abo_start' ).hide();
//                            $( '#kleistad_abo_wijziging' ).prop( { checked: false, disabled: false } );
                            $( '.kleistad_abo_wijziging' ).hide();
 //                           $( '#kleistad_abo_betaalwijze' ).prop( { checked: false, disabled: false } );
