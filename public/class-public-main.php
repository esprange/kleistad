...
class Public_Main {
	...
	public function register_styles_and_scripts() {
		...
		wp_register_style( 'datatables', '//cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css', [], '1.10.21' );
		...
		wp_register_script( 'datatables', '//cdn.datatables.net/1.10.21/js/jquery.dataTables.min.js', [ 'jquery' ], '1.10.21', false );
