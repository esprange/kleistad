...
class Public_Docent_Display extends Public_Shortcode_Display {
	...
	protected function planning() {
		...
		<div style="float: left">
			<button type="button" id="kleistad_default" class="kleistad-button" style="background-color: mediumpurple;" data-confirm="Beschikbaarheid|Weet je zeker dat je dit als standaard planning voor alle weken wilt gebruiken ?">Standaard planning bewaren</button>
		</div>
