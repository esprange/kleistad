		...
		<div class="kleistad-row">
			...
			<div class="kleistad-col-6">
				<input class="kleistad-radio" name="abonnement_keuze" id="kleistad_onbeperkt" type="radio" checked required
					data-bedrag="<?php echo esc_attr( opties()['start_maanden'] * opties()['onbeperkt_abonnement'] ); ?>"
					data-bedragtekst="= <?php echo esc_attr( opties()['start_maanden'] ); ?> termijnen"
		...
		<div class="kleistad-row">
			...
			<div class="kleistad-col-6">
				<input class="kleistad-radio" name="abonnement_keuze" id="kleistad_beperkt" type="radio" required
					data-bedrag="<?php echo esc_attr( opties()['start_maanden'] * opties()['beperkt_abonnement'] ); ?>"
					data-bedragtekst="= <?php echo esc_attr( opties()['start_maanden'] ); ?> termijnen"
