...
class Admin_Instellingen_Display {
	 ...
	 * De technische setup
	 *
	 * @var array $setup De technische opties.
	 */
	private array $setup;
	 ...
	 * De constructor
	 *
	 * @param array $options De opties.
	 * @param array $setup   De setup.
	 */
	public function __construct( array $options, array $setup ) {
	...
	public function instellingen() : void {
		...
		<table class="form-table" >
			...
			<?php
			$index = 1;
			while ( isset( $this->options['extra'][ $index ]['naam'] ) ) :
				?>
			<tr >
				...
				<td><input type="text" class="kleistad-extra regular-text" name="kleistad-opties[extra][<?php echo esc_attr( $index ); ?>][naam]"
						value="<?php echo esc_attr( $this->options['extra'][ $index ]['naam'] ); ?>"  <?php echo ! empty( $this->options['extra'][ $index ]['naam'] ) ? 'readonly' : ''; ?> /></td>
				...
				<td><input type="number" step="0.01" min="0"  name="kleistad-opties[extra][<?php echo esc_attr( $index ); ?>][prijs]" class="small-text"
						value="<?php echo esc_attr( $this->options['extra'][ $index ]['prijs'] ); ?>" /></td>
			</tr>
				<?php
				$index++;
			endwhile;
