...
<form method="POST" >
	<p>Huidige Google connectie status: <strong><?php echo \Kleistad\Google::is_authorized() ? 'gekoppeld' : 'niet gekoppeld'; ?></strong></p>
	<hr/>
	...
	<?php submit_button( 'Google Kalender koppelen', 'primary', 'connect', true, disabled( \Kleistad\Google::is_authorized(), true, false ) ); ?>
	<p>&nbsp;</p>
</form>
</div>
<div class="card" style="float:right;width:50%;" >
